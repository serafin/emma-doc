...
Takie rzeczy jak: zapis dzieci, generowanie lat/lng wedlug adresu, generowanie uriinner nie moze sie odbywac w srodku repozytorium. 
...
Entity posiada pole rel w ktorym sa zapisane relacje do entity slave, kiedy on sam jest w tym polaczeniu masterem.
...
Narazie bedziemy sie trzymac tego zeby typ polaczenia byl rowny typowi slavow. 
...
Pole `rel` mozemy dowolnie modyfikowac. 
Tylko podane klucze `rel` sa brane pod uwage przy zapisie. Np.
...
$entities = $this->module->article->repository->fetchAll(array(
    'contentRel_id_content_slave' => '1234',
