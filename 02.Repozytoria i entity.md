...
2. Podlaczenie pod modul article subskrybera operacji 
...
3. Indeksowanie artykulow dla wyszukiwarki
...
#### Przyklad: Zapisu artykulu na froncie

```
<?php

module_content_operation_publisher::_(array(
    'name'      => 'save',
    'param'     => $entity,
...
$operation = new module_content_operation_publisher();
$operation->name('fetch');
$operation->param(array('content_id' => '1234'));
$operation->module($this->module->article);
$operation->contentId('1234');
