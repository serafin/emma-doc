...
$operation = new module_content_operation_publisher(array(
    'module'    => $this->module->article,  // publikator musi znac typ contentu
    'contentId' => $entity['content_id'],   // i content_id lub content_origin jezeli jest aktualizacja contentu
));
$id = $operation->save($entity);
...
$entity = $operation->fetch(array('content_id' => '1234'));
