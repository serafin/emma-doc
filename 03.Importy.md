...
$importer->fetchAllParam(array('limit' => 10));
    ...
    implements module_import_input_interface, module_import_input_fetchContentOrigin_interface
{
    ...
    public function fetchAll(array $param)
    {
        ...
        $this->importer()->import(
            ...
            array(
                'content_type'   => 'article',         // input zawsze musi podac typ danego entity
                'content_origin' => 'com.ubuntu/1234', // i zawsze content_origin
...
Nastepnie podpinamy inputa pod kontener - klasa `module_import_input`.
